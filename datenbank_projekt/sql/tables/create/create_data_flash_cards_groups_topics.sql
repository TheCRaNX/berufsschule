create table data_flash_cards_groups_topics (
    ...
    flash_card_group_id      	  int not null comment 'Flash card group id for the flash card group topic. Foreign key from data_flash_cards_groups',
    flash_card_topic_id           int not null comment 'Flash card topic id for the flash card group topic. Foreign key from data_flash_cards_topics',
