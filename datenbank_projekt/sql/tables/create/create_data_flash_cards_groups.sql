create table data_flash_cards_groups (
    ...
    user_id                       int comment 'Id of the user who created the flash card group',
    public_flag                   varchar(1) check(public_flag in ('Y', 'N')) comment 'Public flag for flash card group',
    parent_flash_card_group_id    int comment 'Parent flash card group id for flash card group',
